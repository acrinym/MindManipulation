"""
Core audio generation engine for the SBAGEN project.

This module contains all the functions and classes related to parsing schedule
files, generating audio tones (binaural, isochronic, etc.), handling noise,
and mixing audio sources. It is designed to be independent of the user
interface (whether it's a command-line script or a GUI application).
"""
